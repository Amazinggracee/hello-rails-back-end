...
<p align="right"> https://github.com/Amazinggracee/hello-react-front-end</p>
...
```sh
  git clone https://github.com/Amazinggracee/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Amazinggracee/hello-rails-back-end/issues. )
